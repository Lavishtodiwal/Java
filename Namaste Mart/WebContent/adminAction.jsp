...
<%@ page import="com.namastemart.service.impl.UserServiceImp1" %>
...
<html>
    <head>
        ...
        <script src="https://maxcdn.bootstrap.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
        <style>
            body {
                margin:0;
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody style="background-color: #f1cdf6; font-size: 16px;">
                            ...
                            for (UserBean user : userList) {
                                String status = user.inActive() ? "Active" : "Inactive";
                                String actionStatus = user.isActive() ? "Deactivate" : "Activate";
                                String imageSrc = user.getUserImage() != null ? "ImageSevlet?email=" + user.getEmail() : "images/userprofile.png";
                            %>
                            <tr>
