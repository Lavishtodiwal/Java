...
java.util.*" %>
        ...
        <body>
            ...
            <% String userName=(String)session.getAttribute("username"); String
                ...
                response.sendRedirect("login.jsp?message=Session Expired, Login Again!"); return; } String
                addS=request.getParameter("add"); if(addS!=null){ int add=Integer.parseInt(addS); String
                uid=request.getParameter("uid"); String pid=request.getParameter("pid"); int
                avail=Integer.parseInt(request.getParameter("avail")); int
                cartQty=Integer.parseInt(request.getParameter("qty")); CartServiceImpl cart=new CartServiceImpl();
                if(add==1){ cartQty++; if(cartQty<=avail){ cart.addProductToCart(uid,pid,1); } }else if(add==0){
                cart.removeProductFromCart(uid,pid); } response.sendRedirect("cartDetails.jsp"); return; } %>
                ...
                <div class="container">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody style="background-color:#f1cdf6;font-size:15px;font-weight:bold">
                            ...
                            <% CartServiceImpl cart=new CartServiceImpl(); List<CartBean> cartItems=new ArrayList
                                <CartBean>();
                                            ...
                                            <tr style="background-color:#b341ab;color:white">
                                                ...
                                                <td colspan="2" align="center">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <button style="background-color:rgb(7,178,7);color:white"
