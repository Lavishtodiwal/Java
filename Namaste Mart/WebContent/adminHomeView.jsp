...
<%@ page import="com.goole.gson.Gson" %>
...
<body>
    ...
    <div class="content">
        <div class="text-center" style="color: black; font-size: 14px; font-weight: bold;">
            ...
            ProductServiceImp1 prodDao = new ProductServiceImp1();
            OrderServiceImp1 orderDao = new OrderServiceImp1();
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="card-title">Total Transitions Amount</h3>
